 ...
 */
export const penaltyLevelsKeyboard = (settings) => ({
    reply_markup: {
        inline_keyboard: [
            // Buttons to set the strike count for each penalty type.
            [{ text: `Alert Level (current: ${settings.alertLevel})`, callback_data: 'set_alert_level' }],
            [{ text: `Mute Level (current: ${settings.muteLevel})`, callback_data: 'set_mute_level' }],
            [{ text: `Kick Level (current: ${settings.kickLevel})`, callback_data: 'set_kick_level' }],
            [{ text: `Ban Level (current: ${settings.banLevel})`, callback_data: 'set_ban_level' }],
